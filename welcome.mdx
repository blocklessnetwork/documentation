...
<CardGroup cols={2}>
  <Card
    ...
    icon="file-pdf"
    href="https://bless.network/bless_whitepaper_english.pdf"
  >
    Read the Bless whitepaper in English
  </Card>

  <Card
    title="Whitepaper (Korean)"
    icon="file-pdf"
    href="https://bless.network/Bless_Whitepaper_Korean.pdf"
  >
    Bless 백서를 한국어로 읽어보세요
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Run a Node" icon="window" href="/run-a-node/introduction">
    Contribute and start earning
  </Card>

  <Card title="Start Building" icon="code" href="/build-on-bless/introduction">
