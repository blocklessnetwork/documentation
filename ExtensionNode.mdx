---
title: "New file"
description: "How to run a Bless Extension Node"
---
...
**For any support queries, please join the** [Bless Discord](https://discord.gg/blessnetwork) **and open a support ticket at the bottom of the channel after verifying.**
...
3. **Can I use a VPS to run a node?**
   To ensure fairness to all users and simulate the actual environment we'll be running on Mainnet launch VPS's are prohibited and will not be rewarded.
